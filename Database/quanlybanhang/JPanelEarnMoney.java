...
public class JPanelEarnMoney extends JPanel {
	...
	public JPanelEarnMoney() {
		...
		jbuttonRefresh.setIcon(new ImageIcon(JPanelEarnMoney.class.getResource("/icon/352439_refresh_icon.png")));
	...
	public JPanelEarnMoney(Map<String, Object> data) {
		this();
		this.data = data;
		initJFrame();
	}
	...
	public void jbuttonTotal_actionPerformed(ActionEvent e) {
		...
		if(jdateChooser.getDate() == null) {
			for (OutInvoiceDetails outInvoiceDetails : detailsModel.findAlloutinvoicedetailsByStatus(true)) {
				total+= outInvoiceDetails.getTotal();
			}
			jtextFieldTotal.setText(String.valueOf(total));
		} else {
			for (OutInvoiceDetails outInvoiceDetails : detailsModel.findByDate(jdateChooser.getDate(), true)) {
				total+= outInvoiceDetails.getTotal();
			}
			jtextFieldTotal.setText(String.valueOf(total));
		}
